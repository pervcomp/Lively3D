...
function constructor() {
	...
	console.log("conf.focusContainer: " + conf.focusContainer);
...
/*								
	...
	mouse = new Mouse({'target': conf.focusContainer,
                            'onMouseButton': mouseButton,
                            'onMouseMove': mouseMove});
...
updateState = function(state, statusMsg) {
	...
	Util.Debug("UpdateState function, RFB, state: " + state + " statusMSG: " + statusMsg);
    ...
    if (state in {'disconnected':1, 'loaded':1, 'connect':1,
		...
		Util.Debug("UpdateState function, RFB: State is disconnected");
        if (sendTimer) {
		...
		Util.Debug("UpdateState function, RFB: Close");
        ws.close();
    }
    ...
    case 'connect':
        ...
        connTimer = setTimeout(function () {
				Util.Debug("SetTimeout function: Connect timeout, value:" + conf.connectTimeout * 1000);
                fail("Connect timeout");
            }, 10 * 1000); // Was conf.connectTimeout * 1000
