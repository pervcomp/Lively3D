...
function onKeyPress(e) {
    ...
    console.log("onKeyPress kC:" + evt.keyCode + " cC:" + evt.charCode + " w:" + evt.which);
    ...
    if (((evt.which !== "undefined") && (evt.which === 0)) ||
        ...
        console.log("Ignoring special key in keyPress");
        Util.stopEvent(e);
        return false;
    }
...
function onKeyUp(e) {
    ...
    //console.log("onKeyUp   kC:" + evt.keyCode + " cC:" + evt.charCode + " w:" + evt.which);
    ...
    if (conf.onKeyPress && (keysym > 0)) {
        //console.log("keyPress up,   keysym: " + keysym +
        //        " (key: " + evt.keyCode + ", which: " + evt.which + ")");
        console.log("onKeyPress up, keysym: " + keysym +
                   " (onKeyPress key: " + evt.keyCode +
                   ", which: " + evt.which + ")");
...
function onMouseButton(e, down) {
    ...
    if (bmask > 0 && conf.onMouseButton) {
        console.log("onMouseButton " + (down ? "down" : "up") +
                   ", x: " + pos.x + ", y: " + pos.y + ", bmask: " + bmask);
        conf.onMouseButton(UI.lively3DX, UI.lively3DY, down, bmask); // Puukotus
    }
    Util.stopEvent(e);
    return false;
}
...
function onMouseWheel(e) {
	...
	// Puukotus
        conf.onMouseButton(UI.lively3DX, UI.lively3DY, 1, bmask);
        conf.onMouseButton(UI.lively3DX, UI.lively3DY, 0, bmask);
    }
    Util.stopEvent(e);
    return false;
}
...
function onMouseMove(e) {
    ...
    if (conf.onMouseMove) {
		// Puukotus
		conf.onMouseMove(UI.lively3DX, UI.lively3DY);
...
function onMouseDisable(e) {
    ...
    if ((pos.x >= 0) && (pos.y >= 0) &&
		...
		// console.log("onMouseDisable: " + conf.onMouseButton);
        Util.stopEvent(e);
        return false;
    }
